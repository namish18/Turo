          ...
          <div className="relative pt-16 md:pt-24">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground font-bricolage text-sm">
                      🚀 New: Adaptive Offline-First Learning
                    </span>
                ...
                >
                  AI-Driven Personalized Learning for Every Student
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Personalize education with Turo. Adapt to each student’s pace,
                  identify knowledge gaps, and deliver real-time feedback that
                  works online and offline—even on low-cost devices.
                </TextEffect>
